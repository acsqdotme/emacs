...
(custom-set-variables
 ...
 '(package-selected-packages
   '(vertico org-roam magit diminish dashboard rainbow-delimiters rainbow-mode avy ido-vertical-mode smex evil-collection evil undo-fu which-key use-package bind-key)))
(custom-set-faces
